(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stencil-ion-button_2-md-entry-js"], {
    ...
    function node_modulesIonicCoreDistEsmIonButton_2MdEntryJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./helpers-d8b49b57.js */
      "./node_modules/@ionic/core/dist/esm/helpers-d8b49b57.js");
      /* harmony import */


      var _theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./theme-c2dc54d9.js */
        ...
        _createClass(Button, [{
          ...
          value: function render() {
            ...
            return Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
              ...
              "class": Object.assign(Object.assign({}, Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__["c"])(color)), (_Object$assign = {}, _defineProperty(_Object$assign, mode, true), _defineProperty(_Object$assign, buttonType, true), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(expand), expand !== undefined), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(finalSize), finalSize !== undefined), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(shape), shape !== undefined), _defineProperty(_Object$assign, "".concat(buttonType, "-").concat(fill), true), _defineProperty(_Object$assign, "".concat(buttonType, "-strong"), strong), _defineProperty(_Object$assign, 'in-toolbar', Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__["h"])('ion-toolbar', this.el)), _defineProperty(_Object$assign, 'in-toolbar-color', Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_4__["h"])('ion-toolbar[color]', this.el)), _defineProperty(_Object$assign, 'button-has-icon-only', hasIconOnly), _defineProperty(_Object$assign, 'button-disabled', disabled), _defineProperty(_Object$assign, 'ion-activatable', true), _defineProperty(_Object$assign, 'ion-focusable', true), _Object$assign))
            }, Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])(TagType, Object.assign({}, attrs, {
              "class": "button-native",
              disabled: disabled,
      ...
      var Icon = /*#__PURE__*/function () {
        ...
        _createClass(Icon, [{
          ...
          value: function loadIcon() {
            ...
            if (this.isVisible) {
              var url = Object(_utils_35117408_js__WEBPACK_IMPORTED_MODULE_2__["g"])(this);
            ...
            if (!this.ariaLabel) {
              var label = Object(_utils_35117408_js__WEBPACK_IMPORTED_MODULE_2__["a"])(this.name, this.icon, this.mode, this.ios, this.md); // user did not provide a label
          ...
          value: function render() {
            ...
            }, this.svgContent ? Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", {
              "class": "icon-inner",
