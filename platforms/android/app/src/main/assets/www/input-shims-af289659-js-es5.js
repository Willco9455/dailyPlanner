(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["input-shims-af289659-js"], {
    ...
    /***/
    function node_modulesIonicCoreDistEsmInputShimsAf289659Js(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var enableScrollAssist = function enableScrollAssist(componentEl, inputEl, contentEl, keyboardHeight) {
        ...
        var touchEnd = function touchEnd(ev) {
          ...
          var endCoord = Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_0__["p"])(ev); // focus this input if the pointer hasn't moved XX pixels
      ...
      var jsSetFocus = function jsSetFocus(componentEl, inputEl, contentEl, keyboardHeight) {
        ...
        if (typeof window !== 'undefined') {
          var scrollContentTimeout;

          var scrollContent = /*#__PURE__*/function () {
      ...
      var startInputShims = function startInputShims(config) {
        ...
        var registerInput = /*#__PURE__*/function () {
          var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(componentEl) {
            var inputRoot, inputEl, scrollEl, rmFn, _rmFn;
                ...
                switch (_context2.prev = _context2.next) {
                  ...
                  case 8:
                    ...
                    if (!!scrollEl && scrollAssist && !scrollAssistMap.has(componentEl)) {
                      _rmFn = enableScrollAssist(componentEl, inputEl, scrollEl, keyboardHeight);
