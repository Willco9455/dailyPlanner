  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["stencil-ion-modal-ios-entry-js"], {
    ...
    function node_modulesIonicCoreDistEsmIonModalIosEntryJs(module, __webpack_exports__, __webpack_require__) {
      ...
      var iosEnterAnimation = function iosEnterAnimation(baseEl, presentingEl) {
        var backdropAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 0.01, 'var(--backdrop-opacity)').beforeStyles({
          'pointer-events': 'none'
        }).afterClearStyles(['pointer-events']);
        var wrapperAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(100vh)', 'translateY(0vh)');
        var baseAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(500).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().beforeStyles({
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().afterStyles({
                'transform': _finalTransform
      ...
      var iosLeaveAnimation = function iosLeaveAnimation(baseEl, presentingEl) {
        ...
        var backdropAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelector('ion-backdrop')).fromTo('opacity', 'var(--backdrop-opacity)', 0.0);
        var wrapperAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl.querySelectorAll('.modal-wrapper, .modal-shadow')).beforeStyles({
          'opacity': 1
        }).fromTo('transform', 'translateY(0vh)', 'translateY(100vh)');
        var baseAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(baseEl).easing('cubic-bezier(0.32,0.72,0,1)').duration(duration).addAnimation(wrapperAnimation);

        if (presentingEl) {
          var isMobile = window.innerWidth < 768;
          var hasCardModal = presentingEl.tagName === 'ION-MODAL' && presentingEl.presentingElement !== undefined;
          var presentingAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().beforeClearStyles(['transform']).afterClearStyles(['transform']).onFinish(function (currentStep) {
          ...
          if (isMobile) {
            ...
            if (!hasCardModal) {
              ...
              var shadowAnimation = Object(_animation_f72ade61_js__WEBPACK_IMPORTED_MODULE_3__["c"])().addElement(presentingEl.querySelector('.modal-shadow')).afterStyles({
                'transform': 'translateY(0) scale(1)'
              }).keyframes([{
                offset: 0,
                opacity: '0',
        ...
        _createClass(Modal, [{
                ...
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    ...
                    case 5:
                      ...
                      _context2.next = 8;
                      return Object(_framework_delegate_d1eb6504_js__WEBPACK_IMPORTED_MODULE_10__["a"])(this.delegate, container, this.component, ['ion-page'], componentProps);

                    case 8:
                      this.usersElement = _context2.sent;
                      _context2.next = 11;
                      return Object(_index_157155ee_js__WEBPACK_IMPORTED_MODULE_4__["e"])(this.usersElement);
                    ...
                    case 11:
                      ...
                      _context2.next = 14;
                      return Object(_overlays_998692a2_js__WEBPACK_IMPORTED_MODULE_8__["e"])(this, 'modalEnter', iosEnterAnimation, mdEnterAnimation, this.presentingElement);
                ...
                while (1) {
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 2:
                      ...
                      _context3.next = 5;
                      return Object(_overlays_998692a2_js__WEBPACK_IMPORTED_MODULE_8__["f"])(this, data, role, 'modalLeave', iosLeaveAnimation, mdLeaveAnimation, this.presentingElement);
                    ...
                    case 5:
                      ...
                      _context3.next = 9;
                      return Object(_framework_delegate_d1eb6504_js__WEBPACK_IMPORTED_MODULE_10__["d"])(this.delegate, this.usersElement);
          ...
          value: function render() {
            ...
            return Object(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_index_2cd7e630_js__WEBPACK_IMPORTED_MODULE_0__["H"], {
              "no-router": true,
              "aria-modal": "true",
              "class": Object.assign((_Object$assign = {}, _defineProperty(_Object$assign, mode, true), _defineProperty(_Object$assign, "modal-card", this.presentingElement !== undefined && mode === 'ios'), _Object$assign), Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_9__["g"])(this.cssClass)),
              style: {
